...
const filteredVideogamesByGender = videogames.filter((videogame) => videogame.genders.includes('RPG'))

const middleScoresGender = filteredVideogamesByGender.reduce((acc, videogame) => acc + videogame.score / filteredVideogamesByGender.length, 0)

console.log(`La media de los scores de los videojuegos con género RPG es: ${middleScoresGender}`)
